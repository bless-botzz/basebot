...
wa = "wa.me/6283845329280"
ig = "instagram.com/blessbotz_ofc"
tt = "blessreal123"
...
//━━━━━━━━━━━━━━━[ SETTING ]━━━━━━━━━━━━━━━\\
			mess = {
				...
				success: 'Nih deks jan lupa subscribe https://youtube.com/c/MRBLESSwer53Ser',
				error: {
...
const froxx = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `New Base By MhankBarBar`,
                 "title": `New Base By MhankBarBar`,
...
//━━━━━━━━━━━━━━━[ BUAT BIO BOT ]━━━━━━━━━━━━━━━\\
runi = process.uptime() 
           Ramdani.setStatus(`Bless-Botzz Aktif Selama ${kyun(runi)} `).catch((_)=>_);
...
if (isBanned) return reply(mess.banned)
 ...
 footerText: '© Creator By BlessXd Official',
...
878  💎= Rp.196.000
963  💎= Rp.217.000
1427 💎=Rp.281.500 (Promo)
SL (STARLIGHT) MEMBER PLUS=Rp.300.500
 
➖➖➖➖➖➖➖➖➖➖➖
 *_© Creator By BlessXd Official_*    
➖➖➖➖➖➖➖➖➖➖➖`)
break
case 'topupff':
...
case 'bc': 
			...
			"footerText": 'by BlessXd Official',
			"buttons": [
...
┌ > ɢᴇɴᴅᴇʀ : 
┌ > sᴛᴀᴛᴜs :
ᴅᴏɴᴛ ғᴏʀɢᴇᴛ ᴛᴏ sᴜʙsᴄʀɪʙᴇ ʏᴛ ᴍʀ ʙʟᴇss
https://youtube.com/c/MRBLESSwer53Ser
`
...
║        
╠════════════════════
║ _*© CREATOR BY BLESSXD OFFICIAL*_
╚════════════════════`
sendButImage(from, anu,`donasi dulu om\n© Creator By BlessXd Official`, qris, [
